  ...
  return (
    <footer className="footerMain bg-[#141D28] max-w-full">
      <div className="fix12 mx-auto">
        ...
        {/* Footer Middle */}
        <div className="text-white flex-col gap-[40px] md:flex-row flex pt-[32px] w-full justify-evenly pb-[41px] border-b-[rgba(215,215,215,0.34)] border-b">
        ...
        {/* Footer Bottom */}
        <div className="text-white flex md:flex-row flex-col lg:gap-0 gap-[20px] lg:flex-nowrap flex-wrap  items-start justify-evenly pt-[32px]">
