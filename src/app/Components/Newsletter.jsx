...
const Newsletter = () => {
  ...
  return (
    <div className="newLetterSection xl:w-[80%] xl:mx-auto lg:flex justify-between items-end md:pt-[105px] pt-[60px] pb-[40px] md:pb-[60px] border-b border-[rgba(215,215,215,0.34)]">
      <div className="leftCon">
