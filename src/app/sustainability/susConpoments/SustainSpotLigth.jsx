    ...
    <div className="relative bg-[#092241] h-[350px] md:h-[550px] lg:h-[650px] min-1366:h-[95vh] z-0 overflow-hidden">
      ...
      <div className="fix12 pt-[125px] md:pt-[140px] xl-1920:pt-44">
        ...
        >
          ...
          <Link
            href="/"
            className="hover:text-white text-[13px] transition-colors duration-300"
          >
            Home
          </Link>{" "}
          &gt; Sustainability
        ...
        <motion.h1
          ...
          transition={{ duration: 1, ease: [0.7, 0, 0.4, 1] }}
          viewport={{ amount: 0.1, once: true }}
          className="md:text-[60px] text-[24px] md:w-[400px] w-fit ftp-500 text-white border-b-[6px] border-[#F7E327] whitespace-nowrap overflow-hidden"
        >
          Sustainability
        </motion.h1>
      </div>
