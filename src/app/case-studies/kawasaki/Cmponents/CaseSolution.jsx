  ...
  return (
    ...
    >
      ...
      <h4 className="fsans-400 text-[16px] text-[#fff]">
        KSH INFRA integrated the two 125,000 sq. ft. facilities into one 250,000
        sq. ft. facility with internal partitions separating the manufacturing,
        assembly, storage, and R&D divisions.
      </h4>
