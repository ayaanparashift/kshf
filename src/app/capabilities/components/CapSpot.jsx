    ...
    <div className="relative bg-[#092241] min-h-[740px] z-0 overflow-hidden">
      ...
      <div className="fix12 pt-[125px] md:pt-[140px] xl-1920:pt-44">
        ...
        <motion.h1
          ...
          transition={{ duration: 1, ease: [0.7, 0, 0.4, 1] }}
          viewport={{ amount: 0.1, once: true }}
          className="md:text-[60px] text-[30px] text-[24px] md:w-[400px] w-fit fpt-500 text-white border-b-[6px] border-[#F7E327] whitespace-nowrap overflow-hidden"
        >
          Careers
        </motion.h1>
      </div>
